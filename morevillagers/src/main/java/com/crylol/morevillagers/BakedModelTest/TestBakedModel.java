package com.crylol.morevillagers.BakedModelTest;
...
public class TestBakedModel implements IDynamicBakedModel {
    ...
    private BakedQuad createQuad(Vector3d v1, Vector3d v2, Vector3d v3, Vector3d v4, TextureAtlasSprite sprite, BlockState stateIn, Direction side) {
